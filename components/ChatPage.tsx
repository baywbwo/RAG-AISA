...
const ChatPage: React.FC<ChatPageProps> = ({ user, setSidebarOpen }) => {
  ...
  const handleSendMessage = useCallback(async (inputText: string) => {
    ...
    try {
      // Use user.nip as the unique identifier for the Dify API user parameter.
      const stream = streamChat(inputText, user.nip, conversationId);
      let fullResponse = '';
